...
| **Sharpen Python for interviews** | [Python Core Concepts](21-python-and-coding/01-python-core-concepts.md) → [OOP in Python](21-python-and-coding/02-oop-in-python.md) → [DS Coding & SQL Practice](21-python-and-coding/03-ds-coding-and-sql-practice.md) → [Coding Patterns & LeetCode](21-python-and-coding/04-coding-patterns-and-leetcode.md) |
| **Crack the coding round (LeetCode patterns)** | [Coding Patterns & LeetCode](21-python-and-coding/04-coding-patterns-and-leetcode.md) — ~30 patterns (two pointers, sliding window, binary search, BFS/DFS, backtracking, heaps, DP), signal→pattern table, 45-min round strategy, curated study plan |
...
| **Walk through my projects** | [Keystroke Dynamics](23-my-projects/01-keystroke-dynamics-biometric-verification.md) → [Retrieval Optimization](23-my-projects/02-semantic-chunking-and-reranking-retrieval.md) → [LangGraph Coding Agent](23-my-projects/03-langgraph-coding-agent-with-rag.md) → [Distributed ML (Spark+Ray)](23-my-projects/04-distributed-ml-pipeline-pyspark-ray.md) → [Graph RAG over BIAN](23-my-projects/05-graph-rag-over-bian.md) → [Shipping-Time Forecasting](23-my-projects/06-shipping-time-forecasting-catboost.md) → [PO Extraction + BERT](23-my-projects/07-po-extraction-and-bert-classifier.md) → [Seller Behavior Analytics](23-my-projects/08-seller-behavior-analytics.md) |
| **Pass AWS AI certifications (AIF-C01 + MLA-C01 + AIP-C01)** | [AWS AI Certification course](24-aws-ai-certification/README.md) → [Exam Overview & Study Plan](24-aws-ai-certification/00-exam-overview-and-study-plan.md) → AI Practitioner + ML Engineer + **GenAI Developer Professional** tracks, service deep-dives, 210+ practice questions, flashcards |
| **Build production GenAI apps on AWS (AIP-C01)** | [GenAI Developer – Professional track](24-aws-ai-certification/aip-c01/00-exam-overview-and-study-plan.md) → Bedrock model selection & RAG → [Knowledge Bases & vector stores](24-aws-ai-certification/aip-c01/01-foundation-model-integration-data-and-compliance.md) → [Converse API, agents, AgentCore, MCP](24-aws-ai-certification/aip-c01/02-implementation-and-integration.md) → [Guardrails & security](24-aws-ai-certification/aip-c01/03-ai-safety-security-and-governance.md) → cost/latency + evaluation → [55 practice Qs](24-aws-ai-certification/aip-c01/99-practice-questions.md) |
| **Pass AWS Solutions Architect Associate (SAA-C03)** | [SAA-C03 course](25-aws-solutions-architect-associate/README.md) → [Exam Overview & Study Plan](25-aws-solutions-architect-associate/00-exam-overview-and-study-plan.md) → [Secure](25-aws-solutions-architect-associate/01-design-secure-architectures.md) · [Resilient](25-aws-solutions-architect-associate/02-design-resilient-architectures.md) · [High-Performing](25-aws-solutions-architect-associate/03-design-high-performing-architectures.md) · [Cost-Optimized](25-aws-solutions-architect-associate/04-design-cost-optimized-architectures.md) architectures → [services cheatsheet](25-aws-solutions-architect-associate/05-core-services-cheatsheet.md) + [58 practice Qs](25-aws-solutions-architect-associate/99-practice-questions.md) |
| **Master statistics for DS/ML interviews** | [Statistics for Data Science](26-statistics-for-data-science/README.md) → [Probability](26-statistics-for-data-science/02-probability-fundamentals.md) · [Distributions](26-statistics-for-data-science/03-probability-distributions.md) · [Sampling/CLT/Estimation](26-statistics-for-data-science/05-sampling-clt-and-estimation.md) · [Hypothesis Testing](26-statistics-for-data-science/06-hypothesis-testing.md) · [A/B Testing](26-statistics-for-data-science/07-ab-testing-and-experimental-design.md) · [Regression stats](26-statistics-for-data-science/08-regression-and-correlation-statistics.md) · [Bayesian](26-statistics-for-data-science/09-bayesian-statistics.md) · [Causal inference](26-statistics-for-data-science/11-causal-inference-and-biases.md) → [Cheatsheet](26-statistics-for-data-science/12-statistics-interview-cheatsheet.md) |
...
| **Build production RAG** | [Chunking](06-retrieval-systems/02-chunking-strategies.md) → [Vector DBs](06-retrieval-systems/04-vector-databases.md) → [Reranking](06-retrieval-systems/06-reranking-strategies.md) → [Production RAG](06-retrieval-systems/14-production-rag-at-scale.md) → [Production Considerations Checklist](06-retrieval-systems/16-production-rag-considerations.md) → [Text-to-SQL](06-retrieval-systems/17-text-to-sql.md) |
...
├── 21-python-and-coding/        # Python core concepts + OOP + DS/SQL practice + LeetCode coding patterns (two pointers, sliding window, BFS/DFS, backtracking, heaps, DP) & coding-round strategy
├── 22-data-engineering/         # Distributed data processing: Apache Spark architecture, shuffles, Catalyst/Tungsten/AQE
├── 23-my-projects/              # Worked projects w/ narratives + deep-dive topics: keystroke biometrics, RAG retrieval optimization, LangGraph agent, Spark+Ray ML pipeline, Graph RAG over BIAN, CatBoost shipping forecast, PO extraction + BERT, seller behavior analytics
├── 24-aws-ai-certification/     # From-scratch visual course for AWS Certified AI Practitioner (AIF-C01) + ML Engineer Associate (MLA-C01) + GenAI Developer Professional (AIP-C01): per-domain lessons, 15 service deep-dives, 210+ practice Qs, flashcards, cheatsheets
├── 25-aws-solutions-architect-associate/  # SAA-C03 course: 4 domain lessons (secure/resilient/high-performing/cost-optimized) + services cheatsheet + 58 practice Qs, intuition-first with mermaid diagrams
├── 26-statistics-for-data-science/  # Comprehensive stats for DS/ML interviews: descriptive, probability, distributions, expectation/variance, sampling/CLT/estimation, hypothesis testing, A/B testing, regression stats, Bayesian, resampling, causal inference + cheatsheet
