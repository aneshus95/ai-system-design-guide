...
| **Pass AWS AI certifications (AIF-C01 + MLA-C01)** | [AWS AI Certification course](24-aws-ai-certification/README.md) → [Exam Overview & Study Plan](24-aws-ai-certification/00-exam-overview-and-study-plan.md) → AI Practitioner + ML Engineer tracks, service deep-dives, 160 practice questions, flashcards |
...
├── 24-aws-ai-certification/     # From-scratch visual course for AWS Certified AI Practitioner (AIF-C01) + ML Engineer Associate (MLA-C01): per-domain lessons, 15 service deep-dives, 160 practice Qs, 158 flashcards, cheatsheets
